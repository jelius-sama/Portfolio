      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-gray-900/95 backdrop-blur-sm border-b border-orange-500/30">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <a href="/" className="text-gray-300 hover:text-orange-400 transition-colors font-mono text-sm">
              ← Back to Portfolio
            </a>
          </div>
        </div>
      ...
      <main className="pt-20 pb-12 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 font-mono">Monitor your portfolio's performance and visitor insights</p>
          </div>
          ...
          <TerminalWindow title="system-status">
            <div className="font-mono text-sm">
              ...
              <div className="space-y-1 text-gray-300">
                ...
                <div className="ml-2">
                  Active: <span className="text-green-400">active (running)</span> since{" "}
                  {new Date().toLocaleDateString()}
                </div>
                <div className="ml-2">Memory: 45.2M</div>
                <div className="ml-2">CPU: 0.1%</div>
          ...
          <div className="text-center text-gray-500 text-sm font-mono mt-12">
            <div>Analytics Dashboard • Real-time monitoring • Privacy-focused tracking</div>
            <div className="mt-2">Data retention: 90 days • GDPR compliant • No personal data stored</div>
          </div>
        </div>
      </main>
    </div>
